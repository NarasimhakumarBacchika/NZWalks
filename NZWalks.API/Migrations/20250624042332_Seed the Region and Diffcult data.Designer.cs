...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20250624042332_Seed the Region and Diffcult data")]
    partial class SeedtheRegionandDiffcultdata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NZWalks.API.Model.Data.Diffculty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NZWalks.API.Model.Data.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Model.Data.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NZWalks.API.Model.Data.Walk", b =>
                {
                    b.HasOne("NZWalks.API.Model.Data.Diffculty", "Diffculty")
                        .WithMany()
                        .HasForeignKey("DiffcultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NZWalks.API.Model.Data.Region", "Region")
                        .WithMany()
